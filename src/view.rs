...
impl ViewSettings {
    const fn new(view_dimensions: [i32; 2]) -> Self {
        ...
        Self {
            ...
            score_label_pos: IVec2::new(
                playfield_x + playfield_w + 30,
                playfield_y + playfield_h - 30,
            ),
            level_label_pos: IVec2::new(playfield_x - 180, playfield_y + playfield_h - 30),
            title_pos: IVec2::new(playfield_x - 280, playfield_y - 50),
            level_pos: IVec2::new(playfield_x - 60, playfield_y + playfield_h - 30),
            score_pos: IVec2::new(
