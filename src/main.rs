use crate::{
    rustominos::RotationDirection, rustris_board::RustrisBoard,
    rustris_controller::RustrisController, rustris_view::RustrisView,
};
...
fn main() {
    ...
    let mut window: piston_window::PistonWindow =
        piston_window::WindowSettings::new("Rustris", [1280, 720])
            .resizable(false)
            .exit_on_esc(true)
            .vsync(true)
            .build()
